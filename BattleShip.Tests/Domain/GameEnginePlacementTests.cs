...
public class GameEnginePlacementTests
{
    ...
    public async Task CreateGameAsync_PvE_DoesNotPlaceFleets()
    {
        ...
        var engine = new GameEngine(repository, new FleetPlacer(random), new PlayerTokenService(), new DifficultyComputerOpponent(random), random, ObstacleGenerationOptions.None);
